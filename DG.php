...
<body class="contenido">
  ...
  <div class="container">
    <p class="descripcion">
      El técnico laboral en diseño gráfico desarrolla habilidades y destrezas en la producción gráfica de una idea,
      basándose en un concepto de diseño sugerido interpretando órdenes de producción, realizando montajes y arte para
      medios impresos. Crea propuestas de campañas para redes sociales y sitios web
    </p>
  </div>
