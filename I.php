...
<body class="contenido">
  ...
  <div class="container">
    <p class="descripcion">
      El egresado del programa conocimientos académicos pro-eficiencia en inglés desarrolla las competencias en las
      cuatro habilidades (speaking, listening, writing and Reading) establecidas según el marco común Europeo, preparado
      para desarrollar actividades descritas en el campo de acción del programa.
    </p>
  </div>
