...
<body class="contenido">
  ...
  <h1 class="center-align titulo">Técnico Laboral en <?php echo $tecnico; ?></h1>
  <div class="container">
    <p class="descripcion">
      El técnico laboral en contabilidad y finanzas atenderá las necesidades y requerimientos empresariales en materia
      contable. Estará capacitado para organizar, analizar, contabilizar documentos y soportes contables, teniendo como
      herramienta de trabajo los sistemas de información, cumpliendo funciones en manejo de nómina, requisitos contables
      inventarios, gestión de documentos contables y administrativos, presupuestos, análisis de datos financieros,
      liquidación de prestaciones sociales e impuestos
    </p>
  </div>
